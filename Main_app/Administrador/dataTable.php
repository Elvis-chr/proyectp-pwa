...
// ubicaciones guardada para marcador 
/* 
...
<div class="container-fluid" >
      ...
      <div class="d-sm-flex align-items-center justify-content-between mb-4" >
          <h2 class="h3 mb-0 text-gray-800" class="mt-5" > PRUEVA DE MAPA GOOGLE </h2>
...
<!-- Link de mapa de google CON API -->
   ...
   <!--  <script type="text/javascript">
      function initMap() {
          ...
          var marcadores = [
              <?php include('marcadores/marcadores.php'); ?>
          ];

          // Creamos la ventana de información para cada Marcador
          var ventanaInfo = [
              <?php include('marcadores/info_marcadores.php'); ?>
          ];
  ...
  <!--  <script>
    function initMap() {
        const uluru = { lat:-0.966342, lng: -80.708485 };
        ...
        var texto = 
            ' <p> <i class="fas fa-street-view"></i> <b>Instalador</b>: ${d.Nombre}  ${d.Apellido} </p> '+
...
function ObtenerLocalizacion(){
  if (navigator.geolocation){    
        ...
        erroresDiv.innerHTML="Geolocalizacion no soportada por el navegador";
    }
  }

  // Funcion que muestra la ubicacion del usuario en Google Maps
...
function MostrarErrores(error)
  ...
  switch(error.code) 
    ...
    case error.PERMISSION_DENIED:
      erroresDiv.innerHTML="El usuario denego la petición de geolocalización."
      break;
