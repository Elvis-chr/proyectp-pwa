...
<section class="cabecera_fija_uno">
  ...
  <section class="mapa_gis"  >
        <center><h1>LISTADO DE ALARMAS</h1><br></center>
      ...
      <div >
        <table>
                            ...
                            <?php 
                                ...
                                $query = mysqli_query($mysqli, "SELECT u.id_usuario, u.Nombre, u.Apellido, u.Usuario, a.id_alarma, a.usuario_id, a.nombre_alarma 
                                                                FROM usuarios u 
                            ...
                            ?>            
                                <tr>
                                    ...
                                    <td>
                                      <center>
                                        <a class="editar"  href="ver_alarmas.php?id_alarma=<?php echo $data["id_alarma"]?>"><i class="fa fa-eye editar"></i></a>
                                      </center>
                                    </td>
                                </tr>
                            <?php
